...
def test_get_sorted_operations():
    assert get_sorted_operations() == [
        {'id': 863064926, 'state': 'EXECUTED', 'date': '2019-12-08T22:46:21.935582',
         'operationAmount': {'amount': '41096.24', 'currency': {'name': 'USD', 'code': 'USD'}},
         'description': 'Открытие вклада', 'to':
             'Счет 90424923579946435907'}, {'id': 114832369, 'state': 'EXECUTED',
        ...
        {'id': 482520625, 'state': 'EXECUTED',
         'date': '2019-11-13T17:38:04.800051', 'operationAmount': {'amount': '62814.53',
...
def test_check_sender():
    assert check_sender(None) == "Unknown"
    assert check_sender("Счет 19708645243227258542") == "Счет **8542"
    assert check_sender("Maestro 1596837868705199") == "Maestro 1596 83** **** 5199"


def test_print_date():
    assert print_date("2018-06-30T02:08:58.425572") == "30.06.2018"
    assert print_date("Unknown") == "<invalid date format>"
